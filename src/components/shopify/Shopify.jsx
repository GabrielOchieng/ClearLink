import shopifyimg from "../../assets/shopifyimg.png";
  ...
  return (
    <div className="shopifycontainer">
      <div className="shopify">
        <section className="shopifyleft">
            ...
            >
              ...
              <defs>
                <clipPath id="clip0_2_9064">
                  <rect width="112.787" height="32" fill="white"></rect>
                </clipPath>
              </defs>
            </svg>
          </div>
          <div className="staricon">
            <FaStar className="iconst" />
            <FaStar className="iconst" />
            <FaStar className="iconst" />
            <FaStar className="iconst" />
            <FaStar className="iconst" />
          ...
          <div className="words">
            <p>
              ...
              <br />
              video, screen sharing, and <br /> top-notch security make it{" "}
              <br /> essential for our team.
            </p>
          </div>

          <div className="lowestshop">
            <div className="pmdiv">
              <div className="sarahimg">
                <img src={sarah} alt="sarah image" />
              </div>
              <div className="sarahtitle">
                <h3>Sarah Thomson</h3>
                <p>Project Manager, Shopify</p>
              </div>
            </div>
            <div className="arrowiconshop">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="24"
                height="24"
        ...
        <section className="shopifyright">
          <img src={shopifyimg} alt="shopify image" />
        </section>
      </div>
    </div>
  );
